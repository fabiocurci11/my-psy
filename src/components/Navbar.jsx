...
const Navbar = () => {
  ...
  const counter = useSelector((state) => state.counter.value);  // Prendi il valore dal Redux store
   ...
   <>
    <header className="text-gray-600 body-font">
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            ...
            <span className="ml-3 text-xl">MyPsy - Redux Counter: {counter} {user.name}</span>
            </a>
